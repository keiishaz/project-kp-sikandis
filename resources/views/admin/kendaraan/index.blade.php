    ...
    <section class="table-container">
        ...
        <div class="table-header">
            ...
            <div class="table-header-actions">
                ...
                <a href="{{ route('admin.kendaraan.export', request()->query()) }}" class="btn btn-outline">
        ...
        <form class="table-toolbar" method="GET" action="{{ route('admin.kendaraan.index') }}">
                        ...
                        <tr>
                            ...
                            <td class="col-actions" data-label="Aksi">
                                <div class="action-buttons">
                                    ...
                                    <a href="{{ route('admin.kendaraan.edit', $k) }}" class="btn-action btn-edit" title="Edit">
                                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                            <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path>
                                            <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path>
                                        </svg>
                                    </a>
                                    <form action="{{ route('admin.kendaraan.destroy', $k) }}" method="POST" style="display:inline;" onsubmit="return confirm('Hapus data kendaraan ini?');">
                                        @csrf
                                        @method('DELETE')
